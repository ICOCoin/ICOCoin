 ...
 * The ICOCoin Developers 2011-2013
 */
...
{
    resize(850, 550);
    setWindowTitle(tr("ICOCoin Wallet"));
#ifndef Q_WS_MAC
    setWindowIcon(QIcon(":icons/ICOCoin_icon"));
#else
...
void BitcoinGUI::createActions()
{
    ...
    mintingAction = new QAction(QIcon(":/icons/stake"), tr("&View Inputs"), this);
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a ICOCoin address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/ICOCoin_tooltip"), tr("&About ICOCoin"), this);
    aboutAction->setToolTip(tr("Show information about ICOCoin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for ICOCoin"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/ICOCoin_tooltip"), tr("Show/Hide &ICOCoin"), this);
    toggleHideAction->setToolTip(tr("Show or hide the ICOCoin window"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        if(clientModel->isTestNet())
        {
            ...
            setWindowIcon(QIcon(":icons/ICOCoin_icon"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/ICOCoin_icon"));
#endif
            if(trayIcon)
            {
                trayIcon->setToolTip(title_testnet);
                trayIcon->setIcon(QIcon(":/icons/ICOCoin_tooltip"));
            }
        }
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("ICOCoin client"));
    trayIcon->setIcon(QIcon(":/icons/ICOCoin_tooltip"));
