...
static const int STAKE_TARGET_SPACING = 60 * 5;
...
public:
    ...
    {
        // ICOCoin: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64& nCoinAge) const;  // ICOCoin: get transaction coin age
...
public:
    ...
    // ICOCoin: block signature - signed by coin base txout[0]'s owner
    ...
    // ICOCoin: two types of block: proof-of-work or proof-of-stake
    ...
    // ICOCoin: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64& nCoinAge) const; // ICOCoin: calculate total coin age spent in block
    bool SignBlock(const CKeyStore& keystore);
    bool CheckBlockSignature() const;
    unsigned int GetStakeEntropyBit() const; // ICOCoin: entropy bit for stake modifier if chosen by modifier
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    CBigNum bnChainTrust; // ICOCoin: trust score of block chain
    int nHeight;
    int64 nMint;
    int64 nMoneySupply;

    unsigned int nFlags;  // ICOCoin: block index flags
    enum  
    {
