...
// Copyright (c) 2012-2013 The ICOCoin developers
...
// ICOCoin version - intended for display purpose only
#define ICO_VERSION_MAJOR       9
#define ICO_VERSION_MINOR       1
#define ICO_VERSION_REVISION    2
#define ICO_VERSION_BUILD       0

static const int ICO_VERSION =
                           1000000 * ICO_VERSION_MAJOR
                         +   10000 * ICO_VERSION_MINOR
                         +     100 * ICO_VERSION_REVISION
                         +       1 * ICO_VERSION_BUILD;

// ICOCoin version - reference for code tracking
